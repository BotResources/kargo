...
describe('isArtifactAdded', () => {
  ...
  it('reports a package absent from the previous freight as added', () => {
    expect(
      isArtifactAdded(
        create(ChartSchema, {
          repoURL: 'https://charts.example.com',
  ...
  it('does not report a version bump as added', () => {
    expect(
      isArtifactAdded(
        create(ImageSchema, {
          repoURL: 'ghcr.io/akuity/image',
  ...
  it('does not report an unchanged artifact as added', () => {
    expect(
      isArtifactAdded(
        create(ChartSchema, {
          repoURL: 'https://charts.example.com',
